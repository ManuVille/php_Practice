...
if($_POST){
    ...
    $txtNombre= (isset($_POST['txtNombre']))?$_POST['txtNombre']:"";//isset se refiere si hay algun valor entonces se procede a lo siguiente
